...
.mycss{
  ...
  <div class="bg-image">
    ...
    <p class="headline-2">Explore on our pet adoption website</p>
    ...
    <div class="card-container">
      <div class="card">
        <a href="./Add to Cart/Cat_Home1.php"></a>
      ...
      <div class="card">
      <a href="./Add to Cart/Hostel_Home1.php"></a>
        <img src="img/hostel_hmm.png" alt="card image 3">
        <div class="card-content">
          <h2>Hostel</h2>
        </div>
      </div>
      <div class="card" data-card="booked-room-info">
      <a href="./Add to Cart/BookedRoomInfo.php"></a>
        <img src="img/info_hmm.png" alt="card image 3">
        <div class="card-content">
          <h2>Booked Room Info</h2>
        </div>
      </div>
    </div>
  </div>
...
<!-- about us -->
      ...
      <div class="row align-items-center">
        <div class="col-md-6">
          ...
          <p>Furry Friends Foster is likely a program or organization that focuses on fostering animals, such as cats or
            ...
            and
            socialization for the animals while they await adoption.</p>
        </div>
    ...
    <div class="container">
      ...
      <div class="row">
        ...
        <div class="col-md-4 hell2">
          ...
          <div class="hell-img2">
            <h4 style="font-weight:600;padding-top: 15px;">Cat and Dog Boarding</h4>
            <p>Here at 3F, we provide both short- and long-term (based on per-night rates) lodging for our canine and feline friends. Your cat friend will be secure & healthy with us for as few or as many nights as you need.</p>
          </div>
        </div>
  ...
  <section id="footer">
    <div class="container">
      <div class="row align-items-center">
      <h1 class="footer text-center mb-5">Get in touch</h1>
        <div class="col-md-6">
          <h3>Contact</h3>
  ...
  <script>
    ...
    function promptForAdminCredentials(event) {
    event.preventDefault(); // Prevent default link behavior

    const username = prompt("Enter admin username:");
    const password = prompt("Enter admin password:");

    if ((username === "ADMIN" && password === "ADMIN") || (username === "ADMIN1" && password === "ADMIN1") || (username === "ADMIN2" && password === "ADMIN2")) {
      // Redirect to the desired page
      window.location.href = "./Add to Cart/BookedRoomInfo.php";
    } else {
      alert("Invalid admin credentials. Access denied.");
    }
  }

  // Attach event listener to the "Booked Room Info" card link
  const bookedRoomInfoCardLink = document.querySelector(".card[data-card='booked-room-info'] a");
  if (bookedRoomInfoCardLink) {
    bookedRoomInfoCardLink.addEventListener("click", promptForAdminCredentials);
  }
  </script>
